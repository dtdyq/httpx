...
public class MimeMapping {
    ...
    public static String getMimeTypeForExtension(String ext, String def) {
        return m.getOrDefault(ext, def);
    }

    public static String getMimeTypeForExtensionWithOctStream(String ext) {
        return m.getOrDefault(ext, "application/octet-stream");
    }


    public static String getMimeTypeForFilename(String filename) {
        return getMimeTypeForFilename(filename, null);
    }

    public static String getMimeTypeForFilename(String filename, String def) {
        if (filename == null) {
            return def;
        }
        ...
        if (li != -1 && li != filename.length() - 1) {
            ...
            return MimeMapping.getMimeTypeForExtension(ext, def);
        }
        return def;
    }
}
